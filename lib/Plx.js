...
var _index = require('C:\\Users\\Duck\\react-plx\\node_modules\\redbox-react\\lib\\index.js');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('C:\\Users\\Duck\\react-plx\\node_modules\\react-transform-catch-errors\\lib\\index.js');
...
var _index5 = require('C:\\Users\\Duck\\react-plx\\node_modules\\react-transform-hmr\\lib\\index.js');
...
var _CUsersDuckReactPlxNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
  filename: 'source/Plx.js',
  components: _components,
  locals: [module],
  imports: [_react3.default]
});

var _CUsersDuckReactPlxNode_modulesReactTransformCatchErrorsLibIndexJs2 = (0, _index4.default)({
  filename: 'source/Plx.js',
  components: _components,
  locals: [],
...
function _wrapComponent(id) {
  return function (Component) {
    return _CUsersDuckReactPlxNode_modulesReactTransformHmrLibIndexJs2(_CUsersDuckReactPlxNode_modulesReactTransformCatchErrorsLibIndexJs2(Component, id), id);
  };
}
...
var CLIPARRAY_TO_CSS = function CLIPARRAY_TO_CSS(arr) {
  // [[x,y],[x,y]]
  return 'polygon(' + arr.map(function (vertex) {
...
function clipParallax(scrollPosition, start, duration, startValue, endValue, easing) {
  ...
  var result = min.map(function (vertex, i) {
    //vertex = [x,y]
    // console.log(vertex)
    var invertX = vertex[0] > max[i][0];
    var invertY = vertex[1] > max[i][1];

    var bigX = invertX ? vertex[0] : max[i][0];
    var smallX = !invertX ? vertex[0] : max[i][0];
    var bigY = invertY ? vertex[1] : max[i][1];
    var smallY = !invertY ? vertex[1] : max[i][1];

    var targetX = percentage * (bigX - smallX); //just diffs at this point
    var targetY = percentage * (bigY - smallY); //just diffs at this point

    if (invertX) targetX = bigX - targetX;else targetX += vertex[0];

    if (invertY) targetY = bigY - targetY;else targetY += vertex[1];
...
function applyProperty(scrollPosition, propertyData, startPosition, duration, style, easing) {
  ...
  var isClipPath = property === 'clipPath';
  var isColor = COLOR_PROPERTIES.indexOf(property) > -1;
  var parallaxMethod = isClipPath ? clipParallax : isColor ? colorParallax : parallax;
...
var Plx = _wrapComponent('Plx')(function (_Component) {
